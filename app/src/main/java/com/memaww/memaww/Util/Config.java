...
public class Config {
    ...
    // SERVER-SIDE API FOR PLACING CALLBACK REQUEST FOR COLLECTION ORDER
    public static final String LINK_GET_REMAINING_LAUNDRY = CURRENT_HTTP_IN_USE + CURRENT_ENVIRONMENT_DOMAIN_IN_USE + "/api/v1/user/get-remaining-laundry";
    ...
    // SERVER-SIDE API FOR PLACING CALLBACK REQUEST FOR COLLECTION ORDER
    public static final String LINK_GET_MY_MESSAGES = CURRENT_HTTP_IN_USE + CURRENT_ENVIRONMENT_DOMAIN_IN_USE + "/api/v1/user/get-my-messages";

    // SERVER-SIDE API FOR PLACING CALLBACK REQUEST FOR COLLECTION ORDER
    public static final String LINK_GET_SUBSCRIPTION_OFFERS = CURRENT_HTTP_IN_USE + CURRENT_ENVIRONMENT_DOMAIN_IN_USE + "/api/v1/user/get-subscription-pricing";
    ...
    public static final String SHARED_PREF_KEY_USER_CREDENTIALS_USER_PHONE_LOCAL = "USER_PHONE_LOCAL";
    public static final String SHARED_PREF_KEY_USER_CREDENTIALS_USER_PICKUP_ADDRESS = "USER_PICKUP_ADDRESS";
    ...
    //SUBSCRIPTION
    public static final String SHARED_PREF_KEY_USER_SUBSCRIPTION_IS_SET = "SHARED_PREF_KEY_USER_SUBSCRIPTION_IS_SET";
    public static final String SHARED_PREF_KEY_USER_SUBSCRIPTION_INFO = "SHARED_PREF_KEY_USER_SUBSCRIPTION_INFO";
    public static final String SHARED_PREF_KEY_USER_SUBSCRIPTION_ITEMS_WASHED = "SHARED_PREF_KEY_USER_SUBSCRIPTION_ITEMS_WASHED";
    public static final String SHARED_PREF_KEY_USER_SUBSCRIPTION_PICKUPS_DONE = "SHARED_PREF_KEY_USER_SUBSCRIPTION_PICKUPS_DONE";
    public static final String SHARED_PREF_KEY_USER_SUBSCRIPTION_MAX_NUMBER_OF_PEOPLE = "SHARED_PREF_KEY_USER_SUBSCRIPTION_MAX_NUMBER_OF_PEOPLE";
    public static final String SHARED_PREF_KEY_USER_SUBSCRIPTION_NUMBER_OF_MONTHS = "SHARED_PREF_KEY_USER_SUBSCRIPTION_NUMBER_OF_MONTHS";
    public static final String SHARED_PREF_KEY_USER_SUBSCRIPTION_PICKUP_TIME = "SHARED_PREF_KEY_USER_SUBSCRIPTION_PICKUP_TIME";
    public static final String SHARED_PREF_KEY_USER_SUBSCRIPTION_PICKUP_DAY = "SHARED_PREF_KEY_USER_SUBSCRIPTION_PICKUP_DAY";
    public static final String SHARED_PREF_KEY_USER_SUBSCRIPTION_PICKUP_LOCATION = "SHARED_PREF_KEY_USER_SUBSCRIPTION_PICKUP_LOCATION";
    public static final String SHARED_PREF_KEY_USER_SUBSCRIPTION_PACKAGE_DESCRIPTION = "SHARED_PREF_KEY_USER_SUBSCRIPTION_PACKAGE_DESCRIPTION";
    ...
    // GET SHARED PREFERENCE STRING
    public static String getSharedPreferenceStringWithPlaceHolder(Context context, String key, String ifNotSet) {

        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        context = null;
        String theString = preferences.getString(key, "");
        if(theString.trim().equalsIgnoreCase("")){
            return ifNotSet;
        } else {
            return theString;
        }
